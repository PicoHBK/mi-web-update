...
function ProjectCard({ project }: { project: ProjectType }) {
  return (
    <div className="flex flex-col w-full h-full max-w-[400px] gap-3 p-3 bg-mylight-400">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Popover>
            ...
            <PopoverContent className=" flex flex-wrap max-w-40 justify-center gap-3 bg-mylight-200">
